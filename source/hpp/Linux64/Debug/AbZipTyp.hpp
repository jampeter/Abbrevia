...
// (DO NOT EDIT: machine generated header) 'AbZipTyp.pas' rev: 32.00 (Linux)
...
struct TAbZip64EndOfCentralDirectoryRecord;
struct TAbZip64EndOfCentralDirectoryLocator;
struct TAbZipEndOfCentralDirectoryRecord;
struct TAbFollower;
struct TAbSfEntry;
struct TAbSfTree;
